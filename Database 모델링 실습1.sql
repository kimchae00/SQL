...
insert into `Students` values (22311011, 31, 'P31104', '김연아', '651021-1234567', '010-5101-6510', 'yuna@ndaum.net', '대구');
insert into `Students` (`stdNo`, `depNo`, `proNo`, `stdName`, `stdJumin`, `stdHp`, `stdAddr`) 
...
insert into `Students` values (22401003, 42, 'P42103', '강동원', '770314-1234567', '010-8101-7703', 'dong@naver.com', '광주');
