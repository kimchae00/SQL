...
insert into `TblUser` set `userID`='p105', `userName`='이순신', 
                          `userHp`='010-1234-1005', `userAge`=50;
...
insert into `TblProduct` values (4,'세탁기',800,10,'LG','2022-01-06');
